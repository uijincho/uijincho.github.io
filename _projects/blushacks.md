---
layout: page
title: Blu's Hacks 2024, 2025
description: director
img: assets/img/publication_preview/blushacks.png
importance: 3
category: lead
---
...
<div class="row justify-content-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.html path="assets/img/blushacksdirs.png" title="Blu's Hacks Directors" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">Blu's Hacks '24 & '25 Directors</div>

In 2024 and 2025, I served as Director alongside [Kevin Toren](https://www.linkedin.com/in/kevintoren/). Together, we worked to make the event more accessible to beginners by expanding our workshop offerings, recruiting additional mentors, and opening participation to local middle school students in addition to high schoolers.
